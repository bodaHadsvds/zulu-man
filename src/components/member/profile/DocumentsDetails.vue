        ...
        <ul>
          ...
          >
            <h5 class="text-subtitle-1">
              {{
                $vuetify.locale.t(
                  "$vuetify.global.profile.documents.details.types.nutrition_counseling"
                )
              }}:
            </h5>
            <!-- <v-responsive max-width="150" v-if="edit">
              <v-text-field density="compact" variant="outlined" type="number" name="height" v-model="form.height" single-line hide-details></v-text-field>
            </v-responsive> -->
            <p class="text-subtitle-1 text-grey-darken-1" v-if="!edit">
              {{ $vuetify.locale.t("$vuetify.global.no") }}
            </p>
          ...
          >
            <h5 class="text-subtitle-1">
              {{
                $vuetify.locale.t(
                  "$vuetify.global.profile.documents.details.types.facilikey"
                )
              }}:
            </h5>
            <!-- <v-responsive max-width="150" v-if="edit">
              <v-text-field density="compact" variant="outlined" type="number" name="weight" v-model="form.weight" single-line hide-details></v-text-field>
            </v-responsive> -->
            <p class="text-subtitle-1 text-grey-darken-1" v-if="!edit">
              {{ $vuetify.locale.t("$vuetify.global.no") }}
            </p>
