<template>
      <v-toolbar class="bg-background px-0 py-4 pt-0 mt-5">
    <v-row>
      <v-col cols="6" class="d-flex align-center justify-start">
        <h2>
          {{ $vuetify.locale.t("$vuetify.global.session_punch_cards.this") }}
        </h2>
      </v-col>
        ...
        <template v-slot:activator="{ props }">
          <div class="d-flex align-stretch flex-wrap" style="gap: 10px">
            ...
            <v-btn
              ...
              v-bind="props"
            >
              {{ this.$vuetify.locale.t("$vuetify.global.session_punch_cards.add") }}
            </v-btn>
              ...
              <v-container>
                <v-row class="mb-4">
                  ...
                  <v-col cols="12" sm="3">
                    <v-text-field
                      type="text"
                      v-model="editedItem.entrances"
                      :rules="validationRules.entrancesRules"
                      :label="$vuetify.locale.t('$vuetify.global.entrances.this')"
                      :placeholder="
                        $vuetify.locale.t('$vuetify.global.entrances.placeholder')
                      "
                      name="entrances"
                      density="compact"
                      variant="outlined"
    ...
    <v-data-table-server
      ...
      :headers="headers"
      :loading="this.$store.state.memberships.sessionsLoading"
      :items="memberships"
      :items-per-page="10"
      item-value="id"
    ...
    >
      ...
      <template
        v-if="this.$store.state.memberships.sessionsDataSuccess == false"
        v-slot:no-data
      >
        <div class="py-5">
          <svg
      ...
      computed: {
        ...
        headers() {
          return [
            ...
            {
              title: this.$vuetify.locale.t("$vuetify.global.entrances.this"),
              key: "entrances",
            },
            {
        ...
        getMemberships() {
          const memberships = this.$store.getters["memberships/sessions"].data;
        ...
        membershipsTotal() {
          const memberships =
            this.$store.getters["memberships/sessions"].total;
        ...
        validationRules() {
          return {
            ...
            entrancesRules: [
              (value) => {
                if (value) {
                  this.validInputs.entrances = true;
                  return true;
                }
                this.validInputs.entrances = false;
                return this.$vuetify.locale.t("$vuetify.global.entrances.validation");
              },
            ],
            skuRules: [
              (value) => {
